...
::		2.1
::			2018-12-04	rogrwhitakr
::			added date parameter to backup, so no
...
if not exist "%backup_log%_backup.log" echo Logfile for script %title% - Version: %version% > %backup_log%
echo. >> %backup_log%
