...
rem set sql_path=C:\Program Files\Microsoft SQL Server\MSSQL15.SQLSERVER\MSSQL
rem set backup_path=C:\Program Files\Microsoft SQL Server\MSSQL15.SQLSERVER\MSSQL\Backup


cls
set /p instance="Enter instance name: "
set instance="%ComputerName%\%instance%"
